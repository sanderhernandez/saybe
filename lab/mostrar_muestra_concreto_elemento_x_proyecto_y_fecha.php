...
$query = "SELECT m.elemento
	FROM `tbl_lab_muestra_concreto` as m
	WHERE m.id_codigo_proyecto = '" . $id_codigo_proyecto . "' and " . "m.id_fecha_muestra = '" . $id_fecha_muestra .
	"' Group by m.elemento ORDER BY 'm.id_fecha_muestra' DESC";
